  ...
  return (
    <section className="grid h-screen grid-cols-2 gap-3 px-28 py-14 max-lg:grid-cols-1 max-lg:px-10 max-md:px-3">
      <div className="flex max-w-[55ch] flex-col gap-6 text-xl">
        <p className="text-2xl text-gray-400">Het Hornemannhuis</p>
        <h1 className="text-5xl">Interactive video experience</h1>
        <p className="">
          ...
          younger generation about their story, I was part of a three man group
          who created a web-based interactive video experience. By giving the
          visitors different kind of dilemma's like the ones people in WW II had
          to make, they could get a better understanding of the challenges and
          hardships faced during that time.
        </p>
        <p>
          The interactive video experience was built using a combination of
          vanilla HTML, CSS and JavaScript. This project aimed to engage users
          by allowing them to interact with video content in a dynamic way,
          simalar too Kahoot.
        </p>
        <p>
